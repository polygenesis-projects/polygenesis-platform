...
public class RestDeducerImpl implements RestDeducer {
  ...
  @Override
  public RestModelRepository deduce(ThingRepository thingRepository) {
    return new RestModelRepository(resourceDeducer.deduceFrom(thingRepository, rootPackageName));
  }
}
