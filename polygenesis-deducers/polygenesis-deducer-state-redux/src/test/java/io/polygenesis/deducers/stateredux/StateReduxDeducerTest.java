...
public class StateReduxDeducerTest {
  ...
  public void deduce() {
    ...
    StateReduxDeducer stateReduxDeducer = new StateReduxDeducer(storeDeducer);
    ...
    StoreMetamodelRepository reactiveStateModelRepository =
        stateReduxDeducer.deduce(abstractionRepositories, modelRepositories());
