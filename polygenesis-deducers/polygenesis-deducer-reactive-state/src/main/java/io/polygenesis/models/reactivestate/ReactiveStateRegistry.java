...
/**
 * The type Reactive state registry.
 *
 * @author Christos Tsakostas
 */
public class ReactiveStateRegistry {

  private ReactiveStateRegistry() {
  ...
  /**
   * Gets reactive state deducer.
   *
   * @return the reactive state deducer
   */
  public static ReactiveStateDeducer getReactiveStateDeducer() {
    return reactiveStateDeducer;
  }
}
