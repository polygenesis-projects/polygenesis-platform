 ...
 */
public class FunctionToMethodRepresentationTransformer extends AbstractMethodTransformer<Function> {
  ...
  /**
   * Instantiates a new Function to method representation transformer.
   *
   * @param fromDataTypeToJavaConverter the from data type to java converter
   */
  public FunctionToMethodRepresentationTransformer(
