...
/**
 * The type Abstract dart transformer.
 *
 * @author Christos Tsakostas
 */
public class AbstractDartTransformer {
  ...
  /**
   * Instantiates a new Abstract dart transformer.
   *
   * @param dataTypeTransformer the data type transformer
   */
  public AbstractDartTransformer(DataTypeTransformer dataTypeTransformer) {
