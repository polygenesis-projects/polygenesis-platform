...
/**
 * The type Abstract dart class transformer.
 *
 * @param <S> the type parameter
 * @param <F> the type parameter
 * @author Christos Tsakostas
 */
public abstract class AbstractDartClassTransformer<S extends Nameable, F extends FunctionProvider>
    extends AbstractDartTransformer implements ClassTransformer<S> {
  ...
  /**
   * Instantiates a new Abstract dart class transformer.
   *
   * @param dataTypeTransformer the data type transformer
   * @param methodTransformer the method transformer
   */
  public AbstractDartClassTransformer(
  ...
  protected String makeImport(
      PackageName rootPackageName, PackageName packageName, String dataType) {
    // TODO
    // return packageName.getText() + "." + TextConverter.toUpperCamel(dataType);
    return TextConverter.toUpperCamel(dataType) + ".dart";
  }
