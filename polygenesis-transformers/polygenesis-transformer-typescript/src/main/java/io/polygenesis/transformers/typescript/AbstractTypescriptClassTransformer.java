...
public abstract class AbstractTypescriptClassTransformer<
  ...
  /**
   * Instantiates a new Abstract typescript class transformer.
   *
   * @param dataTypeTransformer the data type transformer
   */
  protected AbstractTypescriptClassTransformer(DataTypeTransformer dataTypeTransformer) {
   ...
   */
  protected AbstractTypescriptClassTransformer(
