...
public abstract class AbstractLegacyClassTransformer<S> extends AbstractTransformer
  ...
  /**
   * Instantiates a new Abstract legacy class transformer.
   *
   * @param dataTypeTransformer the data type transformer
   */
  public AbstractLegacyClassTransformer(DataTypeTransformer dataTypeTransformer) {
   ...
   * @return the string
   */
  protected String packageName(DataObject modelGroup) {
   ...
   * @return the string
   */
  protected String simpleObjectName(DataObject modelGroup) {
   ...
   * @return the string
   */
  protected String fullObjectName(DataObject modelGroup) {
