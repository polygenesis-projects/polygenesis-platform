...
public abstract class DeducerRequest {
   ...
   *
   * @param thingRepository the core model repository
   */
  public DeducerRequest(ThingRepository thingRepository) {
  ...
  private void setThingRepository(ThingRepository thingRepository) {
