...
/**
 * The type Api service projection maker.
 *
 * @author Christos Tsakostas
 */
public class ApiServiceProjectionMaker extends AbstractServiceProjectionMaker {
  ...
  /**
   * Instantiates a new Api service projection maker.
   *
