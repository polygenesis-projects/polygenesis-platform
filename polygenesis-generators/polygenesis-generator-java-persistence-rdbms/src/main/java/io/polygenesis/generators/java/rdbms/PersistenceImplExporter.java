...
public class PersistenceImplExporter {
   ...
   */
  public PersistenceImplExporter(FreemarkerService freemarkerService) {
  ...
  public void export(Path generationPath, AggregateRoot aggregateRoot) {
    ...
    dataModel.put("aggregateRoot", aggregateRoot);
  ...
  private Path makeFileName(Path generationPath, AggregateRoot aggregateRoot) {
    ...
    return Paths.get(
        ...
        TextConverter.toUpperCamel(aggregateRoot.getName().getText()) + "PersistenceImpl.java");
  }
}
