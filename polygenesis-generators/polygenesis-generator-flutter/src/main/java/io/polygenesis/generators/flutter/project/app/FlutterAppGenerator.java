...
/**
 * The type Flutter app generator.
 *
...
public class FlutterAppGenerator extends AbstractUnitTemplateGenerator<FlutterApp> {
  ...
  /**
   * Instantiates a new Flutter app generator.
   *
   * @param flutterAppTransformer the flutter app transformer
   * @param templateEngine the template engine
   * @param exporter the exporter
   */
  public FlutterAppGenerator(
      FlutterAppTransformer flutterAppTransformer,
