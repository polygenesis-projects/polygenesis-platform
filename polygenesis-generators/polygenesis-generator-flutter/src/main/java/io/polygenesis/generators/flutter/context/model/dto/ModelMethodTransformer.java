...
/**
 * The type Model method transformer.
 *
...
public class ModelMethodTransformer extends AbstractDartMethodTransformer<ModelMethod> {
  ...
  /**
   * Instantiates a new Model method transformer.
   *
   * @param dataTypeTransformer the data type transformer
   * @param activityRegistry the activity registry
   */
  public ModelMethodTransformer(
      DataTypeTransformer dataTypeTransformer, ModelActivityRegistry activityRegistry) {
