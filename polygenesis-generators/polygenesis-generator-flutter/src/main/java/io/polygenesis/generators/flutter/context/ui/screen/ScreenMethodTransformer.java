...
/**
 * The type Screen method transformer.
 *
...
public class ScreenMethodTransformer extends AbstractDartMethodTransformer<Function> {
  ...
  /**
   * Instantiates a new Screen method transformer.
   *
   * @param dataTypeTransformer the data type transformer
   * @param activityRegistry the activity registry
   */
  public ScreenMethodTransformer(
      DataTypeTransformer dataTypeTransformer, ScreenActivityRegistry activityRegistry) {
