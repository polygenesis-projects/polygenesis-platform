...
public class ProviderDetailMethodTransformer extends AbstractDartMethodTransformer<ProviderMethod> {
  ...
  /**
   * Instantiates a new Provider detail method transformer.
   *
   * @param dataTypeTransformer the data type transformer
   * @param activityRegistry the activity registry
   */
  public ProviderDetailMethodTransformer(
      DataTypeTransformer dataTypeTransformer, ProviderDetailActivityRegistry activityRegistry) {
