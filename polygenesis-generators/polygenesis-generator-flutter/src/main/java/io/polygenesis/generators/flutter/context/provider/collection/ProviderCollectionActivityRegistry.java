 ...
 */
public class ProviderCollectionActivityRegistry extends AbstractActivityRegistry<ProviderMethod> {
  ...
  /** Instantiates a new Provider collection activity registry. */
  public ProviderCollectionActivityRegistry() {
