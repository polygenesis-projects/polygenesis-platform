...
public class JavaApiDetailGeneratorFactoryTest {

  @Test
  public void shouldFailToInstantiate() throws NoSuchMethodException {
    Constructor<JavaApiDetailGeneratorFactory> constructor =
        JavaApiDetailGeneratorFactory.class.getDeclaredConstructor();
  ...
  public void shouldCreateNewInstance() {
    JavaApiDetailGenerator javaApiGenerator =
        JavaApiDetailGeneratorFactory.newInstance(Paths.get("tmp"), new PackageName("com.oregor"));
