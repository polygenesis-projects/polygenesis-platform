...
public class JavaApiDetailMetamodelGeneratorFactoryTest {

  @Test
  public void shouldFailToInstantiate() throws NoSuchMethodException {
    Constructor<JavaApiDetailMetamodelGeneratorFactory> constructor =
        JavaApiDetailMetamodelGeneratorFactory.class.getDeclaredConstructor();
