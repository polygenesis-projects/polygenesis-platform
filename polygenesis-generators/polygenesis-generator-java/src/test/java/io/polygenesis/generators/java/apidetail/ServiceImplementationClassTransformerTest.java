 ...
 */
public class ServiceImplementationClassTransformerTest {

  private FromDataTypeToJavaConverter fromDataTypeToJavaConverter;
  private ServiceMethodImplementationTransformer methodProjectionMaker;
  ...
  public void setUp() {
    ...
    methodProjectionMaker = mock(ServiceMethodImplementationTransformer.class);
