...
/**
 * The type To collection record activity transformer.
 *
 * @author Christos Tsakostas
 */
public class ToCollectionRecordActivityTransformer extends AbstractConverterActivityTransformer
  ...
  public TemplateData transform(DomainObjectConverterMethod source, Object... args) {
    ...
    return new TemplateData(
        ...
        "polygenesis-trinity-java/api-detail/"
            + "converter/convert-domain-object-to-collection-record.java.ftl");
  }
}
