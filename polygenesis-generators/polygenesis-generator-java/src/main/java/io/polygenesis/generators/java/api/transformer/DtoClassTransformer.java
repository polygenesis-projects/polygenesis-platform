 ...
 */
public class DtoClassTransformer extends AbstractClassTransformer<Dto> {
   ...
   */
  public DtoClassTransformer(FromDataTypeToJavaConverter fromDataTypeToJavaConverter) {
