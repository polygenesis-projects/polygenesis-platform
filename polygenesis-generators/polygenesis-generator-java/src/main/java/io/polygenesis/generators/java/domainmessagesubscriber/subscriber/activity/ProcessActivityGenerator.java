...
/**
 * The type Process activity generator.
 *
...
public class ProcessActivityGenerator extends AbstractActivityTemplateGenerator<Function> {
  ...
  /**
   * Instantiates a new Process activity generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   */
  public ProcessActivityGenerator(
      ProcessActivityTransformer templateTransformer, TemplateEngine templateEngine) {
