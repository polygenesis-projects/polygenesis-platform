...
/**
 * The type Get return value activity transformer.
 *
 * @author Christos Tsakostas
 */
public class GetReturnValueActivityTransformer
  ...
  public TemplateData transform(Function source, Object... args) {
    ...
    dataModel.put("data", new GetReturnValueActivityTemplateData());

    return new TemplateData(
        dataModel, "polygenesis-trinity-java/api-detail/" + "aspect/get-return-value.java.ftl");
  }
}
