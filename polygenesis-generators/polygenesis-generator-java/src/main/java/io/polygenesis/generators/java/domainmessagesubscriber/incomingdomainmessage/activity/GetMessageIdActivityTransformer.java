...
/**
 * The type Get message id activity transformer.
 *
 * @author Christos Tsakostas
 */
public class GetMessageIdActivityTransformer extends AbstractServiceMethodImplementationTransformer
  ...
  public TemplateData transform(Function source, Object... args) {
    GetMessageIdActivityTemplateData data = new GetMessageIdActivityTemplateData();
    ...
    return new TemplateData(
        ...
        "polygenesis-trinity-java/api-clients/"
            + "api-client-domain-message-subscriber/incoming-get-message-id.java.ftl");
  }
}
