...
/**
 * The type Batch process subscriber registry generator.
 *
...
public class BatchProcessSubscriberRegistryGenerator
  ...
  /**
   * Instantiates a new Batch process subscriber registry generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   * @param exporter the exporter
   */
  public BatchProcessSubscriberRegistryGenerator(
      BatchProcessSubscriberRegistryTransformer templateTransformer,
