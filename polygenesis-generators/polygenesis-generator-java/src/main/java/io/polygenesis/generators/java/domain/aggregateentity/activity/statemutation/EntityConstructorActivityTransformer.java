...
/**
 * The type Entity constructor activity transformer.
 *
 * @author Christos Tsakostas
 */
public class EntityConstructorActivityTransformer
  ...
  public TemplateData transform(StateMutationMethod source, Object... args) {
    ...
    dataModel.put(
        "data", new EntityConstructorActivityTemplateData(parameterRepresentations, domainEvent));

    return new TemplateData(
        dataModel, "polygenesis-trinity-java/domain/" + "aggregate-entity/constructor.java.ftl");
  }
}
