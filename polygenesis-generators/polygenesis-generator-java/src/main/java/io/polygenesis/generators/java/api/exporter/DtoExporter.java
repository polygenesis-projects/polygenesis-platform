...
public class DtoExporter {
  ...
  private final DtoClassTransformer dtoClassTransformer;
   ...
   * @param dtoClassTransformer the dto class representable
   */
  public DtoExporter(FreemarkerService freemarkerService, DtoClassTransformer dtoClassTransformer) {
    this.freemarkerService = freemarkerService;
    this.dtoClassTransformer = dtoClassTransformer;
  }
  ...
  private void export(Path generationPath, Dto dto) {
    ...
    dataModel.put("representation", dtoClassTransformer.create(dto));
