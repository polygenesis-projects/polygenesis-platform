...
package io.polygenesis.generators.java.apidetail.activity.converter;

import io.polygenesis.commons.freemarker.FreemarkerService;
import io.polygenesis.generators.java.apidetail.activity.service.AbstractServiceMethodImplementor;
...
/**
 * The type Convert domain object to collection record.
 *
 * @author Christos Tsakostas
 */
public class ConvertDomainObjectToCollectionRecord extends AbstractServiceMethodImplementor
  ...
  public String implementationFor(
    ...
    return freemarkerService.exportToString(
        dataModel,
        "polygenesis-implementation-java-apiimpl/convert-domain-object-to-collection-record.ftl");
  }
}
