...
/**
 * The type Update aggregate entity template data.
 *
 * @author Christos Tsakostas
 */
public class UpdateAggregateEntityTemplateData extends AbstractAggregateEntityTemplateData {
  ...
  /**
   * Instantiates a new Update aggregate entity template data.
   *
