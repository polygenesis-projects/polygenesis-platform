...
/**
 * The type Ensure existence of aggregate root generator.
 *
 * @author Christos Tsakostas
 */
public class EnsureExistenceOfAggregateRootGenerator
  ...
  /**
   * Instantiates a new Ensure existence of aggregate root generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   */
  public EnsureExistenceOfAggregateRootGenerator(
      EnsureExistenceOfAggregateRootTransformer templateTransformer,
