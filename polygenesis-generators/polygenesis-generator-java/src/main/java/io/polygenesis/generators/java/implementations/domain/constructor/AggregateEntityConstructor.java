...
/**
 * The type Aggregate entity constructor.
 *
 * @author Christos Tsakostas
 */
public class AggregateEntityConstructor implements MethodImplementor<Constructor> {
  ...
  public String implementationFor(
    ...
    return freemarkerService.exportToString(
        dataModel,
        "polygenesis-implementation-java-domain/constructor/create-aggregate-entity.ftl");
  }
}
