 ...
 */
public class MessagingMetamodelGenerator extends AbstractMetamodelGenerator {
   ...
   */
  public MessagingMetamodelGenerator(Path generationPath, SubscriberExporter subscriberExporter) {
