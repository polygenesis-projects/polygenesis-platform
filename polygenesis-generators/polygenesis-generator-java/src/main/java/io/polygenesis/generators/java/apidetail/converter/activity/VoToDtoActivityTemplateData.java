...
/**
 * The type Vo to dto activity template data.
 *
 * @author Christos Tsakostas
 */
public class VoToDtoActivityTemplateData extends AbstractConverterActivityTemplateData {
  ...
  /**
   * Instantiates a new Vo to dto activity template data.
   *
   * @param parameterRepresentations the parameter representations
   * @param from the from
   * @param to the to
   */
  public VoToDtoActivityTemplateData(
