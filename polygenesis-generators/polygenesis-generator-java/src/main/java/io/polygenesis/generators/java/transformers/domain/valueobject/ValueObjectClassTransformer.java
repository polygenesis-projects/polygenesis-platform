...
package io.polygenesis.generators.java.transformers.domain.valueobject;
 ...
 */
public class ValueObjectClassTransformer extends AbstractClassTransformer<ValueObject> {
   ...
   */
  public ValueObjectClassTransformer(FromDataTypeToJavaConverter fromDataTypeToJavaConverter) {
