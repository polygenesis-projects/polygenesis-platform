...
/**
 * The type Fetch one aggregate entity generator.
 *
 * @author Christos Tsakostas
 */
public class FetchOneAggregateEntityGenerator
  ...
  /**
   * Instantiates a new Fetch one aggregate entity generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   */
  public FetchOneAggregateEntityGenerator(
      FetchOneAggregateEntityTransformer templateTransformer, TemplateEngine templateEngine) {
