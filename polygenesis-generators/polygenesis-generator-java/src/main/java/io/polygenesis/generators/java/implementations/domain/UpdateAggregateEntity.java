 ...
 */
public class UpdateAggregateEntity implements MethodImplementor<StateMutationMethod> {
  ...
  public String implementationFor(
      ...
      StateMutationMethod methodProvider,
    ...
    return freemarkerService.exportToString(
        dataModel, "polygenesis-implementation-java-domain/update-aggregate-entity.ftl");
  }
}
