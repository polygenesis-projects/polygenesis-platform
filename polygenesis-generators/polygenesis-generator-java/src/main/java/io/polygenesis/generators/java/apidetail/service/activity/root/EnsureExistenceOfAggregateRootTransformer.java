...
/**
 * The type Ensure existence of aggregate root transformer.
 *
 * @author Christos Tsakostas
 */
public class EnsureExistenceOfAggregateRootTransformer
  ...
  public TemplateData transform(ServiceMethodImplementation source, Object... args) {
    ...
    return new TemplateData(
        ...
        "polygenesis-trinity-java/api-detail/"
            + "aggregate-root/ensure-existence-of-aggregate-root.java.ftl");
  }
}
