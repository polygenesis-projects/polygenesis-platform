...
/**
 * The type Fetch one aggregate entity activity transformer.
 *
...
public class FetchOneAggregateEntityActivityTransformer extends ResourceActivityTransformer {
  ...
  /**
   * Instantiates a new Fetch one aggregate entity activity transformer.
   *
   * @param resourceMethodParameterRepresentationService the resource method parameter
   *     representation service
   */
  public FetchOneAggregateEntityActivityTransformer(
  ...
  public TemplateData transform(Endpoint source, Object... args) {
    ...
    dataModel.put(
        "data",
        new FetchOneAggregateEntityActivityTemplateData(
    ...
    return new TemplateData(
        dataModel,
        "polygenesis-trinity-java/api-clients/" + "api-client-rest/fetch-one-aggregate-entity.ftl");
  }
}
