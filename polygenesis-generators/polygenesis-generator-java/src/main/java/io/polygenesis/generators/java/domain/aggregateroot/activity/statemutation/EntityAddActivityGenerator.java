...
/**
 * The type Entity add activity generator.
 *
 * @author Christos Tsakostas
 */
public class EntityAddActivityGenerator
  ...
  /**
   * Instantiates a new Entity add activity generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   */
  public EntityAddActivityGenerator(
      EntityAddActivityTransformer templateTransformer, TemplateEngine templateEngine) {
