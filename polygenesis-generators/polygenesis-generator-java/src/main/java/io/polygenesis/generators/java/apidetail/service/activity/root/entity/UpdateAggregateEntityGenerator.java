...
/**
 * The type Update aggregate entity generator.
 *
 * @author Christos Tsakostas
 */
public class UpdateAggregateEntityGenerator
  ...
  /**
   * Instantiates a new Update aggregate entity generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   */
  public UpdateAggregateEntityGenerator(
      UpdateAggregateEntityTransformer templateTransformer, TemplateEngine templateEngine) {
