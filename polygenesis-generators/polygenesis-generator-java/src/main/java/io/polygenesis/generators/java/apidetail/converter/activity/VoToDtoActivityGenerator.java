...
/**
 * The type Vo to dto activity generator.
 *
 * @author Christos Tsakostas
 */
public class VoToDtoActivityGenerator
  ...
  /**
   * Instantiates a new Vo to dto activity generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   */
  public VoToDtoActivityGenerator(
      VoToDtoActivityTransformer templateTransformer, TemplateEngine templateEngine) {
