...
package io.polygenesis.generators.java.transformers.domain.persistence;
 ...
 */
public class PersistenceInterfaceTransformer extends AbstractRepositoryInterfaceTransformer {
  ...
  public PersistenceInterfaceTransformer(
