...
public class ServiceExporter {
  ...
  private final ServiceInterfaceRepresentable serviceInterfaceRepresentable;
  ...
  public ServiceExporter(
    ...
    this.serviceInterfaceRepresentable = serviceInterfaceRepresentable;
  }
  ...
  public void export(Path generationPath, Service service) {
    ...
    dataModel.put("representation", serviceInterfaceRepresentable.create(service));
