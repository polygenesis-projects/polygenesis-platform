...
public class SpringDomainMessagePublishedDataRepository extends AbstractNameablePackageable
  ...
  /**
   * Instantiates a new Spring domain message published data repository.
   *
   * @param objectName the object name
   * @param packageName the package name
   */
  public SpringDomainMessagePublishedDataRepository(
      ObjectName objectName, PackageName packageName) {
