...
/**
 * The type Aggregate root converter projection.
 *
 * @author Christos Tsakostas
 */
public class AggregateRootConverterProjection extends ObjectProjection {
  ...
  /**
   * Instantiates a new Aggregate root converter projection.
   *
   ...
   * @param functionProjections the function projections
   */
  public AggregateRootConverterProjection(
      String packageName,
      Set<String> imports,
      String description,
      String objectName,
