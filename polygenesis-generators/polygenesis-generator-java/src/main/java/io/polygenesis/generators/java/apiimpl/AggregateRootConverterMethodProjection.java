...
/**
 * The type Aggregate root converter method projection.
 *
 * @author Christos Tsakostas
 */
public class AggregateRootConverterMethodProjection extends FunctionProjection {
  ...
  /**
   * Instantiates a new Aggregate root converter method projection.
   *
   ...
   */
  public AggregateRootConverterMethodProjection(
      Function function,
      String name,
      String description,
      String returnValue,
