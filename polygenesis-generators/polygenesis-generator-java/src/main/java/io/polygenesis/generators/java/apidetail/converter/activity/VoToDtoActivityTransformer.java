...
/**
 * The type Vo to dto activity transformer.
 *
 * @author Christos Tsakostas
 */
public class VoToDtoActivityTransformer extends AbstractConverterActivityTransformer
  ...
  public TemplateData transform(DomainObjectConverterMethod source, Object... args) {
    ...
    dataModel.put(
        "data",
        new VoToDtoActivityTemplateData(
            createParameterRepresentations(source), source.getFrom(), source.getTo()));

    return new TemplateData(
        dataModel, "polygenesis-trinity-java/api-detail/" + "converter/convert-vo-to-dto.java.ftl");
  }
}
