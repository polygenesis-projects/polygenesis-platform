...
/**
 * The type Supportive entity id generator.
 *
...
public class SupportiveEntityIdGenerator extends AbstractUnitTemplateGenerator<SupportiveEntityId> {
  ...
  /**
   * Instantiates a new Supportive entity id generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   * @param exporter the exporter
   */
  public SupportiveEntityIdGenerator(
      SupportiveEntityIdTransformer templateTransformer,
