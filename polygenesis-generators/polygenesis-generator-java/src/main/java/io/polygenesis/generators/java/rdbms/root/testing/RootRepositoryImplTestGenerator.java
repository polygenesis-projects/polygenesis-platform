...
/**
 * The type Root repository impl test generator.
 *
...
public class RootRepositoryImplTestGenerator extends AbstractUnitTemplateGenerator<Persistence> {
  ...
  /**
   * Instantiates a new Root repository impl test generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   * @param exporter the exporter
   */
  public RootRepositoryImplTestGenerator(
      RootRepositoryImplTestTransformer templateTransformer,
