...
/**
 * The type Create aggregate root activity transformer.
 *
 * @author Christos Tsakostas
 */
public class CreateAggregateRootActivityTransformer extends ResourceActivityTransformer {
  ...
  /**
   * Instantiates a new Create aggregate root activity transformer.
   *
   * @param resourceMethodParameterRepresentationService the resource method parameter
   *     representation service
   */
  public CreateAggregateRootActivityTransformer(
  ...
  public TemplateData transform(Endpoint source, Object... args) {
    ...
    dataModel.put(
        "data",
        new CreateAggregateRootActivityTemplateData(
    ...
    return new TemplateData(
        dataModel,
        "polygenesis-trinity-java/api-clients/" + "api-client-rest/create-aggregate-root.ftl");
  }
}
