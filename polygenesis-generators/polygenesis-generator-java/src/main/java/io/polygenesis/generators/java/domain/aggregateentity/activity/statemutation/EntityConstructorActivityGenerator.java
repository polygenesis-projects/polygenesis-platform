...
/**
 * The type Entity constructor activity generator.
 *
 * @author Christos Tsakostas
 */
public class EntityConstructorActivityGenerator
  ...
  /**
   * Instantiates a new Entity constructor activity generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   */
  public EntityConstructorActivityGenerator(
      EntityConstructorActivityTransformer templateTransformer, TemplateEngine templateEngine) {
