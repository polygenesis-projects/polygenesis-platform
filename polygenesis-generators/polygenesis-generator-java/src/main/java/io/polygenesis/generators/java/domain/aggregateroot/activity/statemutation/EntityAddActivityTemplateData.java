...
/**
 * The type Entity add activity template data.
 *
 * @author Christos Tsakostas
 */
public class EntityAddActivityTemplateData extends AbstractEntityMutationActivityTemplateData {
  ...
  /**
   * Instantiates a new Entity add activity template data.
   *
   * @param aggregateEntityData the aggregate entity data
   * @param properties the properties
   */
  public EntityAddActivityTemplateData(
