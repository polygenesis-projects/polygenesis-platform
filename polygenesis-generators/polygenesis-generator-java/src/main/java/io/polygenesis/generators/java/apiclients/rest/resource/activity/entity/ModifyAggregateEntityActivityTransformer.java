...
/**
 * The type Modify aggregate entity activity transformer.
 *
 * @author Christos Tsakostas
 */
public class ModifyAggregateEntityActivityTransformer extends ResourceActivityTransformer {
  ...
  /**
   * Instantiates a new Modify aggregate entity activity transformer.
   *
   * @param resourceMethodParameterRepresentationService the resource method parameter
   *     representation service
   */
  public ModifyAggregateEntityActivityTransformer(
  ...
  public TemplateData transform(Endpoint source, Object... args) {
    ...
    dataModel.put(
        "data",
        new ModifyAggregateEntityActivityTemplateData(
    ...
    return new TemplateData(
        dataModel,
        "polygenesis-trinity-java/api-clients/" + "api-client-rest/modify-aggregate-entity.ftl");
  }
}
