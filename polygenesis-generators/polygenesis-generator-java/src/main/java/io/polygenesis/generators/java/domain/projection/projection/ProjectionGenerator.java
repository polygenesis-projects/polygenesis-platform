...
public class ProjectionGenerator extends AbstractUnitTemplateGenerator<Projection> {
  ...
  /**
   * Instantiates a new Projection generator.
   *
  ...
  public ProjectionGenerator(
      ProjectionTransformer templateTransformer, TemplateEngine templateEngine, Exporter exporter) {
