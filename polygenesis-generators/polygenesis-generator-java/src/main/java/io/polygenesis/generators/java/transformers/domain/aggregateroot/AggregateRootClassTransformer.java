 ...
 */
public class AggregateRootClassTransformer extends DomainObjectClassTransformer<AggregateRoot> {

  // ===============================================================================================
  // DEPENDENCIES
  // ===============================================================================================

  private final StateMutationMethodTransformer stateMutationMethodRepresentable;
   ...
   */
  public AggregateRootClassTransformer(
