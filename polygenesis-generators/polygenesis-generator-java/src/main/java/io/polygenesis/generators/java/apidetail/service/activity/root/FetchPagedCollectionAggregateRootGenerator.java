...
/**
 * The type Fetch paged collection aggregate root generator.
 *
 * @author Christos Tsakostas
 */
public class FetchPagedCollectionAggregateRootGenerator
  ...
  /**
   * Instantiates a new Fetch paged collection aggregate root generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   */
  public FetchPagedCollectionAggregateRootGenerator(
      FetchPagedCollectionAggregateRootTransformer templateTransformer,
