...
/**
 * The type Entity modify activity transformer.
 *
 * @author Christos Tsakostas
 */
public class EntityModifyActivityTransformer extends AbstractServiceMethodImplementationTransformer
  ...
  public TemplateData transform(StateMutationMethod source, Object... args) {
    ...
    dataModel.put(
        "data", new EntityModifyActivityTemplateData(parameterRepresentations, domainEvent));

    return new TemplateData(
        dataModel, "polygenesis-trinity-java/domain/" + "aggregate-entity/modify.java.ftl");
  }
}
