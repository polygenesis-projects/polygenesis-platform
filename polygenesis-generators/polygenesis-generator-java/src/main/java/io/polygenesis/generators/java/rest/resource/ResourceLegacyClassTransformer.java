...
package io.polygenesis.generators.java.rest.resource;
 ...
 */
public class ResourceLegacyClassTransformer extends AbstractLegacyClassTransformer<Resource> {

  // ===============================================================================================
  // DEPENDENCIES
  // ===============================================================================================

  private final EndpointLegacyMethodTransformer endpointMethodRepresentable;
