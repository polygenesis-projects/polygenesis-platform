...
/**
 * The type Enumeration generator.
 *
 * @author Christos Tsakostas
 */
public class EnumerationGenerator extends AbstractUnitTemplateGenerator<Enumeration> {
  ...
  /**
   * Instantiates a new Enumeration generator.
   *
  ...
  public EnumerationGenerator(
      EnumerationTransformer templateTransformer,
