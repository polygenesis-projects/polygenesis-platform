...
/**
 * The type Update aggregate root generator.
 *
 * @author Christos Tsakostas
 */
public class UpdateAggregateRootGenerator
  ...
  /**
   * Instantiates a new Update aggregate root generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   */
  public UpdateAggregateRootGenerator(
      UpdateAggregateRootTransformer templateTransformer, TemplateEngine templateEngine) {
