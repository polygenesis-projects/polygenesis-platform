...
/**
 * The type Ensure existence of aggregate root template data.
 *
 * @author Christos Tsakostas
 */
public class EnsureExistenceOfAggregateRootTemplateData extends AbstractAggregateRootTemplateData {
  ...
  /**
   * Instantiates a new Ensure existence of aggregate root template data.
   *
   ...
   */
  public EnsureExistenceOfAggregateRootTemplateData(
