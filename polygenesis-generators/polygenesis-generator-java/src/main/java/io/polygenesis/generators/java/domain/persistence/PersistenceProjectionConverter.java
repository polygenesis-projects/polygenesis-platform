...
/**
 * The type Persistence projection converter.
 *
 * @author Christos Tsakostas
 */
public class PersistenceProjectionConverter extends AbstractObjectProjectionMaker
  ...
  /**
   * Instantiates a new Persistence projection converter.
   *
   * @param fromDataTypeToJavaConverter the from data type to java converter
   */
  public PersistenceProjectionConverter(FromDataTypeToJavaConverter fromDataTypeToJavaConverter) {
  ...
  protected String projectObjectNameWithOptionalExtendsImplements(Persistence persistence) {
    ...
    stringBuilder.append(
        TextConverter.toUpperCamel(persistence.getAggregateRootIdName().getText()));
    stringBuilder.append(">");
