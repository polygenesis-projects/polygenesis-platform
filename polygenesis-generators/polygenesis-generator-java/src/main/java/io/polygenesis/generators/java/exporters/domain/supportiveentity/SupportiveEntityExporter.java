...
package io.polygenesis.generators.java.exporters.domain.supportiveentity;
...
public class SupportiveEntityExporter {
  ...
  private final SupportiveEntityLegacyClassTransformer supportiveEntityClassRepresentable;
