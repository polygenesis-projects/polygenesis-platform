...
/**
 * The type Property file impl generator.
 *
...
public class PropertyFileImplGenerator extends AbstractUnitTemplateGenerator<PropertyFileImpl> {
  ...
  /**
   * Instantiates a new Property file impl generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   * @param exporter the exporter
   */
  public PropertyFileImplGenerator(
      PropertyFileImplTransformer templateTransformer,
