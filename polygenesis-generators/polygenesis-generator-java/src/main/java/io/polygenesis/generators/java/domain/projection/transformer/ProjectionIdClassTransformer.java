 ...
 */
public class ProjectionIdClassTransformer extends AbstractClassTransformer<Projection> {
   ...
   */
  public ProjectionIdClassTransformer(FromDataTypeToJavaConverter fromDataTypeToJavaConverter) {
