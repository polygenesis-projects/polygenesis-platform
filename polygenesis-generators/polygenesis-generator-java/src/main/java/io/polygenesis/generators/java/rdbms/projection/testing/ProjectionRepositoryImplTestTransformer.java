...
/**
 * The type Projection repository impl test transformer.
 *
 * @author Christos Tsakostas
 */
public class ProjectionRepositoryImplTestTransformer
  ...
  /**
   * Instantiates a new Projection repository impl test transformer.
   *
   * @param dataTypeTransformer the data type transformer
   * @param methodTransformer the method transformer
   */
  @SuppressWarnings("CPD-START")
  public ProjectionRepositoryImplTestTransformer(
      DataTypeTransformer dataTypeTransformer,
      ProjectionRepositoryImplTestMethodTransformer methodTransformer) {
  ...
  public Set<MethodRepresentation> methodRepresentations(Persistence source, Object... args) {
    ...
    MethodRepresentation methodRepresentation =
        new MethodRepresentation(
            ...
            "Should store and restore projection.",
