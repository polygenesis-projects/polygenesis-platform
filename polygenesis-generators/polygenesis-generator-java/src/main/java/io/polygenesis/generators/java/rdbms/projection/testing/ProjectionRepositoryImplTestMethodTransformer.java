...
/**
 * The type Projection repository impl test method transformer.
 *
 * @author Christos Tsakostas
 */
public class ProjectionRepositoryImplTestMethodTransformer
  ...
  /**
   * Instantiates a new Projection repository impl test method transformer.
   *
