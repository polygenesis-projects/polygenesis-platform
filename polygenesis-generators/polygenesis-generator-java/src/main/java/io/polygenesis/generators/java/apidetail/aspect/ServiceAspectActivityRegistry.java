...
import io.polygenesis.generators.java.apidetail.aspect.activity.GetReturnValueActivityGenerator;
import io.polygenesis.generators.java.apidetail.aspect.activity.GetReturnValueActivityTransformer;
  ...
  static {
    ...
    scopeAndPurposeMap.put(
        new ScopePurposeTuple(
            AbstractionScope.apiDetail(), Purpose.apiDetailServiceAspectGetReturnValue()),
        new GetReturnValueActivityGenerator(
            new GetReturnValueActivityTransformer(), templateEngine));
  }
}
