...
/**
 * The type Fetch one aggregate root template data.
 *
 * @author Christos Tsakostas
 */
public class FetchOneAggregateRootTemplateData extends UpdateAggregateRootTemplateData {
  ...
  /**
   * Instantiates a new Fetch one aggregate root template data.
   *
