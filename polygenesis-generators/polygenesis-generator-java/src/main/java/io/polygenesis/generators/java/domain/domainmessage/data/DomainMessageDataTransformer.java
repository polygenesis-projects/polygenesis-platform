...
package io.polygenesis.generators.java.domain.domainmessage.data;
...
/**
 * The type Domain message data transformer.
 *
 * @author Christos Tsakostas
 */
public class DomainMessageDataTransformer
    extends AbstractClassTransformer<DomainMessageData, Function> {
  ...
  /**
   * Instantiates a new Domain message data transformer.
   *
   * @param dataTypeTransformer the data type transformer
   * @param methodTransformer the method transformer
   */
  public DomainMessageDataTransformer(
      DataTypeTransformer dataTypeTransformer,
      DomainMessageDataMethodTransformer methodTransformer) {
  ...
  @Override
  public TemplateData transform(DomainMessageData source, Object... args) {
  ...
  public Set<ConstructorRepresentation> constructorRepresentations(
      DomainMessageData source, Object... args) {
  ...
  @Override
  public String packageName(DomainMessageData source, Object... args) {
    return source.getPackageName().getText();
  }

  @Override
  public Set<String> imports(DomainMessageData source, Object... args) {
    Set<String> imports = new TreeSet<>();

    imports.add("com.oregor.trinity4j.domain.AbstractDomainMessageData");
  ...
  @Override
  public Set<String> annotations(DomainMessageData source, Object... args) {
    return new LinkedHashSet<>(
        Arrays.asList(
            "@Entity", "@Table(name = Constants.DEFAULT_TABLE_PREFIX + \"domain_message_data\")"));
  }

  @SuppressWarnings("CPD-END")
  @Override
  public String fullObjectName(DomainMessageData source, Object... args) {
    return String.format("%s extends AbstractDomainMessageData", simpleObjectName(source, args));
  }
}
