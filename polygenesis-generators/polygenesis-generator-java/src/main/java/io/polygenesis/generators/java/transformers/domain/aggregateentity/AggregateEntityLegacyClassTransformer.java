 ...
 */
public class AggregateEntityLegacyClassTransformer
    extends DomainObjectLegacyClassTransformer<AggregateEntity> {
   ...
   */
  public AggregateEntityLegacyClassTransformer(
