...
/**
 * The type Domain message method subscriber registry transformer.
 *
 * @author Christos Tsakostas
 */
public class DomainMessageMethodSubscriberRegistryTransformer
  ...
  /**
   * Instantiates a new Domain message method subscriber registry transformer.
   *
