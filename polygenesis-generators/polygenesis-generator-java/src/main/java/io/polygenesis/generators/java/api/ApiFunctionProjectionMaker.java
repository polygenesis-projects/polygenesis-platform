 ...
 */
public class ApiFunctionProjectionMaker extends AbstractFunctionProjectionMaker {
   ...
   */
  public ApiFunctionProjectionMaker(FromDataTypeToJavaConverter fromDataTypeToJavaConverter) {
