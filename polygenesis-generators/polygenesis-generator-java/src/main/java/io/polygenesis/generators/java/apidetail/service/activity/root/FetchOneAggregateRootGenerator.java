...
/**
 * The type Fetch one aggregate root generator.
 *
 * @author Christos Tsakostas
 */
public class FetchOneAggregateRootGenerator
  ...
  /**
   * Instantiates a new Fetch one aggregate root generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   */
  public FetchOneAggregateRootGenerator(
      FetchOneAggregateRootTransformer templateTransformer, TemplateEngine templateEngine) {
