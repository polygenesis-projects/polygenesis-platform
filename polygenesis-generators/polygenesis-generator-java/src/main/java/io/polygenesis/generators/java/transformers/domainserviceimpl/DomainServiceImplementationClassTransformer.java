 ...
 */
public class DomainServiceImplementationClassTransformer
    extends AbstractClassTransformer<DomainService> {
   ...
   */
  public DomainServiceImplementationClassTransformer(
