...
/**
 * The type Batch process publisher send activity transformer.
 *
 * @author Christos Tsakostas
 */
public class BatchProcessPublisherSendActivityTransformer
  ...
  public TemplateData transform(Function source, Object... args) {
    BatchProcessPublisherSendActivityTemplateData data =
        new BatchProcessPublisherSendActivityTemplateData();
