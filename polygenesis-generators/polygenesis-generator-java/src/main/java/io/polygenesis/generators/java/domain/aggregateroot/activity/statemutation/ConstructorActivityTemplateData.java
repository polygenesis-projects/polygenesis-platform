...
/**
 * The type Constructor activity template data.
 *
 * @author Christos Tsakostas
 */
public class ConstructorActivityTemplateData {
  ...
  /**
   * Instantiates a new Constructor activity template data.
   *
   * @param parameterRepresentations the parameter representations
   * @param domainEvent the domain event
   */
  @SuppressWarnings("CPD-START")
  public ConstructorActivityTemplateData(
  ...
  private void distinguishBetweenSuperAndThisClassParameters(
    ...
    this.thisClassParameterRepresentations =
        parameterRepresentations
            .stream()
            .filter(
                parameterRepresentation ->
