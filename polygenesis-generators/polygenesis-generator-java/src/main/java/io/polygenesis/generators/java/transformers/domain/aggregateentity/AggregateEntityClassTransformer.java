...
package io.polygenesis.generators.java.transformers.domain.aggregateentity;
 ...
 */
public class AggregateEntityClassTransformer extends DomainObjectClassTransformer<AggregateEntity> {
   ...
   */
  public AggregateEntityClassTransformer(FromDataTypeToJavaConverter fromDataTypeToJavaConverter) {
