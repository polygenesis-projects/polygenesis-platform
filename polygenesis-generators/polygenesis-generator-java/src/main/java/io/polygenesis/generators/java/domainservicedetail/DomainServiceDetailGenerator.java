...
/**
 * The type Domain service detail generator.
 *
...
public class DomainServiceDetailGenerator extends AbstractUnitTemplateGenerator<DomainService> {
  ...
  /**
   * Instantiates a new Domain service detail generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   * @param exporter the exporter
   */
  public DomainServiceDetailGenerator(
      DomainServiceDetailTransformer templateTransformer,
