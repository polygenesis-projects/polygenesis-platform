...
/**
 * The type Batch process command generator.
 *
 * @author Christos Tsakostas
 */
public class BatchProcessCommandGenerator
  ...
  /**
   * Instantiates a new Batch process command generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   * @param exporter the exporter
   */
  public BatchProcessCommandGenerator(
      BatchProcessCommandTransformer templateTransformer,
