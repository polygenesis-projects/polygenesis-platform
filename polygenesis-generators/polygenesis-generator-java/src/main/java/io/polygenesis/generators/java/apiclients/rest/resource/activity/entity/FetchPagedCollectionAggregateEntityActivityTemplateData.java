...
/**
 * The type Fetch paged collection aggregate entity activity template data.
 *
 * @author Christos Tsakostas
 */
public class FetchPagedCollectionAggregateEntityActivityTemplateData
  ...
  /**
   * Instantiates a new Fetch paged collection aggregate entity activity template data.
   *
  ...
  public FetchPagedCollectionAggregateEntityActivityTemplateData(
