...
public class ModifyAggregateRootActivityTransformer extends ResourceActivityTransformer {
  ...
  /**
   * Instantiates a new Modify aggregate root activity transformer.
   *
   * @param resourceMethodParameterRepresentationService the resource method parameter
   *     representation service
   */
  public ModifyAggregateRootActivityTransformer(
  ...
  public TemplateData transform(Endpoint source, Object... args) {
    ...
    return new TemplateData(
        dataModel,
        "polygenesis-trinity-java/api-clients/" + "api-client-rest/modify-aggregate-root.ftl");
  }
}
