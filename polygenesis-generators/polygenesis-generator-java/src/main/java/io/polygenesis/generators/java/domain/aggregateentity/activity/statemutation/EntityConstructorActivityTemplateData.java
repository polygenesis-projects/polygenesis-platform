...
/**
 * The type Entity constructor activity template data.
 *
...
public class EntityConstructorActivityTemplateData {
  ...
  /**
   * Instantiates a new Entity constructor activity template data.
   *
   * @param parameterRepresentations the parameter representations
   * @param domainEvent the domain event
   */
  @SuppressWarnings("CPD-START")
  public EntityConstructorActivityTemplateData(
