...
/**
 * The type Abstract subscriber.
 *
 * @author Christos Tsakostas
 */
public class AbstractSubscriber extends AbstractNameablePackageable {
  ...
  // ===============================================================================================
  /**
   * Instantiates a new Abstract subscriber.
   *
   * @param objectName the object name
   * @param packageName the package name
   */
  public AbstractSubscriber(ObjectName objectName, PackageName packageName) {
