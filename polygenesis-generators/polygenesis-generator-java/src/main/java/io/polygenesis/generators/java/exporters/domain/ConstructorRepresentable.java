...
import io.polygenesis.generators.java.skeletons.MethodRepresentationType;
 ...
 */
public class ConstructorRepresentable extends AbstractMethodRepresentable<Constructor> {
   ...
   */
  public ConstructorRepresentable(
