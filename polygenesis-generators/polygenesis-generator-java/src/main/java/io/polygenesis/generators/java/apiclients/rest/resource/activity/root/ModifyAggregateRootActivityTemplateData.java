...
/**
 * The type Modify aggregate root activity template data.
 *
 * @author Christos Tsakostas
 */
public class ModifyAggregateRootActivityTemplateData extends ResourceActivityTemplateData {
  ...
  /**
   * Instantiates a new Modify aggregate root activity template data.
   *
  ...
  public ModifyAggregateRootActivityTemplateData(
