...
/**
 * The type Batch process query generator.
 *
 * @author Christos Tsakostas
 */
public class BatchProcessQueryGenerator
  ...
  /**
   * Instantiates a new Batch process query generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   * @param exporter the exporter
   */
  public BatchProcessQueryGenerator(
      BatchProcessQueryTransformer templateTransformer,
