 ...
 */
public class SpringDataRepositoryGenerator extends AbstractUnitTemplateGenerator<Persistence> {
   ...
   */
  public SpringDataRepositoryGenerator(
      SpringDataRepositoryTransformer templateTransformer,
