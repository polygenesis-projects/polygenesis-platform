...
/**
 * The type Get root id activity transformer.
 *
 * @author Christos Tsakostas
 */
public class GetRootIdActivityTransformer extends AbstractServiceMethodImplementationTransformer
  ...
  public TemplateData transform(Function source, Object... args) {
    GetRootIdActivityTemplateData data = new GetRootIdActivityTemplateData();
