...
/**
 * The type Batch process method subscriber registry transformer.
 *
 * @author Christos Tsakostas
 */
public class BatchProcessMethodSubscriberRegistryTransformer
  ...
  /**
   * Instantiates a new Periodic process method transformer.
   *
