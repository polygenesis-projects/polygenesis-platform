...
public class DomainMessagePublisherTransformer
  ...
  public DomainMessagePublisherTransformer(
      ...
      DomainMessagePublisherMethodTransformer methodTransformer) {
  ...
  public Set<ConstructorRepresentation> constructorRepresentations(
    ...
    String endpoint =
        String.format(
            "context.%s.domain-detail.domain-message.publisher",
            contextName.getText().toLowerCase());
    parameterRepresentations.add(
  ...
  public Set<String> imports(DomainMessagePublisher source, Object... args) {
    ...
    imports.add("com.oregor.trinity4j.domain.DomainMessagePublisher");
    ...
    imports.addAll(methodTransformer.imports(source.getSend(), args));
  ...
  public String fullObjectName(DomainMessagePublisher source, Object... args) {
    ...
    return String.format(
        "%s implements DomainMessagePublisher<%sDomainMessagePublishDto>",
