 ...
 */
public class PersistenceImplClassTransformer extends AbstractRepositoryImplClassTransformer {
   ...
   */
  public PersistenceImplClassTransformer(FromDataTypeToJavaConverter fromDataTypeToJavaConverter) {
