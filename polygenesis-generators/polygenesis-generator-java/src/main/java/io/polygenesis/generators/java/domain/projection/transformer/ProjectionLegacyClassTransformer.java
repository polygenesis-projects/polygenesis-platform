 ...
 */
public class ProjectionLegacyClassTransformer
    extends DomainObjectLegacyClassTransformer<Projection> {
   ...
   */
  public ProjectionLegacyClassTransformer(FromDataTypeToJavaConverter fromDataTypeToJavaConverter) {
