 ...
 */
public class DomainMessageMethodAbstractSubscriberTransformer
  ...
  /**
   * Instantiates a new Domain message method abstract subscriber transformer.
   *
   * @param dataTypeTransformer the data type transformer
   */
  public DomainMessageMethodAbstractSubscriberTransformer(DataTypeTransformer dataTypeTransformer) {
