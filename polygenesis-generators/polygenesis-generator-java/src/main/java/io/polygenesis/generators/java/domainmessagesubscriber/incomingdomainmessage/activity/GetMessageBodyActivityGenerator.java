...
/**
 * The type Get message body activity generator.
 *
...
public class GetMessageBodyActivityGenerator extends AbstractActivityTemplateGenerator<Function> {
  ...
  /**
   * Instantiates a new Get message body activity generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   */
  public GetMessageBodyActivityGenerator(
      GetMessageBodyActivityTransformer templateTransformer, TemplateEngine templateEngine) {
