...
/**
 * The type Aggregate entity id generator.
 *
...
public class AggregateEntityIdGenerator extends AbstractUnitTemplateGenerator<AggregateEntity> {
  ...
  /**
   * Instantiates a new Aggregate entity id generator.
   *
   * @param templateTransformer the template transformer
   * @param templateEngine the template engine
   * @param exporter the exporter
   */
  public AggregateEntityIdGenerator(
      AggregateEntityIdTransformer templateTransformer,
