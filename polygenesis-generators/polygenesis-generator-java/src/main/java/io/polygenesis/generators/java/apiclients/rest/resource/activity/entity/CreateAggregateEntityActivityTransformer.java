...
/**
 * The type Create aggregate entity activity transformer.
 *
 * @author Christos Tsakostas
 */
public class CreateAggregateEntityActivityTransformer extends ResourceActivityTransformer {
  ...
  /**
   * Instantiates a new Create aggregate entity activity transformer.
   *
   * @param resourceMethodParameterRepresentationService the resource method parameter
   *     representation service
   */
  public CreateAggregateEntityActivityTransformer(
  ...
  public TemplateData transform(Endpoint source, Object... args) {
    ...
    return new TemplateData(
        dataModel,
        "polygenesis-trinity-java/api-clients/" + "api-client-rest/create-aggregate-entity.ftl");
  }
}
