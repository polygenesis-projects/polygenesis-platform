...
/**
 * The type Update aggregate entity transformer.
 *
 * @author Christos Tsakostas
 */
public class UpdateAggregateEntityTransformer extends AbstractServiceMethodImplementationTransformer
  ...
  /**
   * Instantiates a new Update aggregate entity transformer.
   *
  ...
  public UpdateAggregateEntityTransformer(
  ...
  public TemplateData transform(ServiceMethodImplementation source, Object... args) {
    ...
    return new TemplateData(
        ...
        "polygenesis-trinity-java/api-detail/"
            + "aggregate-root/aggregate-entity/modify-aggregate-entity.java.ftl");
  }
}
