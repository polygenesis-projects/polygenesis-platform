...
package io.polygenesis.generators.java.messaging.subscriber;
 ...
 */
public class SubscriberLegacyMethodTransformer
    extends AbstractLegacyMethodTransformer<SubscriberMethod> {
   ...
   */
  public SubscriberLegacyMethodTransformer(
