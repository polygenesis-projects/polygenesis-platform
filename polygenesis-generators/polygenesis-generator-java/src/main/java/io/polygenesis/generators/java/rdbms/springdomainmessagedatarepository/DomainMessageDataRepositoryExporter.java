...
package io.polygenesis.generators.java.rdbms.springdomainmessagedatarepository;
...
public class DomainMessageDataRepositoryExporter {
  ...
  public void export(Path generationPath, PackageName rootPackageName, ObjectName context) {
    ...
    dataModel.put(
        "description",
        "The " + TextConverter.toUpperCamel(context.getText()) + "Spring Domain Message Data Repository.");
    dataModel.put(
        "simpleObjectName",
        TextConverter.toUpperCamel(context.getText() + "SpringDomainMessageDataRepository"));
    dataModel.put(
        "fullObjectName",
        TextConverter.toUpperCamel(context.getText() + "SpringDomainMessageDataRepository")
    ...
    freemarkerService.export(
        ...
        "polygenesis-trinity-java/domain-details/"
            + "domain-detail-repository-springdatajpa/ContextSpringDomainMessageDataRepository.java.ftl",
  ...
  private Path makeDomainMessageDataRepositoryFileName(
    ...
    return Paths.get(
        ...
        TextConverter.toUpperCamel(context.getText()) + "SpringDomainMessageDataRepository.java");
  }
}
