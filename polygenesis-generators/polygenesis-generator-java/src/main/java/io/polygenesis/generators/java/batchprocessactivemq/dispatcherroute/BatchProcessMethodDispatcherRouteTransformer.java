...
/**
 * The type Batch process method dispatcher route transformer.
 *
 * @author Christos Tsakostas
 */
public class BatchProcessMethodDispatcherRouteTransformer
  ...
  /**
   * Instantiates a new Batch process method dispatcher route transformer.
   *
   * @param dataTypeTransformer the data type transformer
   * @param configureActivityGenerator the configure activity generator
   */
  public BatchProcessMethodDispatcherRouteTransformer(
