...
public class ServiceImplementationTestExporter {
  ...
  private final ServiceImplementationTestClassRepresentable apiImplServiceTestProjectionConverter;
  ...
  public ServiceImplementationTestExporter(
      ...
      ServiceImplementationTestClassRepresentable apiImplServiceTestProjectionConverter) {
