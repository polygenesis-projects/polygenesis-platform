 ...
 */
public class ProjectionClassRepresentable extends DomainObjectClassRepresentable<Projection> {
   ...
   */
  public ProjectionClassRepresentable(FromDataTypeToJavaConverter fromDataTypeToJavaConverter) {
