...
/**
 * The type Domain message configure activity transformer.
 *
 * @author Christos Tsakostas
 */
public class DomainMessageConfigureActivityTransformer
  ...
  public TemplateData transform(Function source, Object... args) {
    DomainMessageConfigureActivityTemplateData data =
        new DomainMessageConfigureActivityTemplateData();
