...
/**
 * The type Fetch paged collection aggregate entity activity transformer.
 *
 * @author Christos Tsakostas
 */
public class FetchPagedCollectionAggregateEntityActivityTransformer
  ...
  /**
   * Instantiates a new Fetch paged collection aggregate entity activity transformer.
   *
   * @param resourceMethodParameterRepresentationService the resource method parameter
   *     representation service
   */
  public FetchPagedCollectionAggregateEntityActivityTransformer(
  ...
  public TemplateData transform(Endpoint source, Object... args) {
    ...
    return new TemplateData(
        ...
        "polygenesis-trinity-java/api-clients/"
            + "api-client-rest/fetch-paged-collection-aggregate-entity.ftl");
  }
}
