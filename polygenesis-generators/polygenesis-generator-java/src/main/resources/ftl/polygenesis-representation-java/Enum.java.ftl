...
${ representation.modifiers }<#if representation.modifiers != ""> </#if>enum ${ representation.fullObjectName } {
<#if representation.staticFieldRepresentations?size == 0
  ...
  && representation.enumerationValueRepresentations?size == 0>
  // No operation
</#if>
<#if representation.enumerationValueRepresentations?size gt 0>
    <#list representation.enumerationValueRepresentations as enumerationValueRepresentation>
  ${ enumerationValueRepresentation.value }<#sep>,</#sep>
    </#list>
</#if>
