...
/**
 * The type Angular context generator.
 *
 * @author Christos Tsakostas
 */
public class AngularContextGenerator extends AbstractContextGenerator {
   ...
   */
  public AngularContextGenerator(Path generationPath, Set<MetamodelGenerator> metamodelGenerators) {
