...
/**
 * The type Screen scss generator.
 *
...
public class ScreenScssGenerator extends AbstractUnitTemplateGenerator<Screen> {
  ...
  /**
   * Instantiates a new Screen scss generator.
   *
   * @param screenScssTransformer the screen scss transformer
   * @param templateEngine the template engine
   * @param exporter the exporter
   */
  public ScreenScssGenerator(
      ScreenScssTransformer screenScssTransformer,
