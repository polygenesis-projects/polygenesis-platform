...
/**
 * The type Screen html generator.
 *
...
public class ScreenHtmlGenerator extends AbstractUnitTemplateGenerator<Screen> {
  ...
  /**
   * Instantiates a new Screen html generator.
   *
   * @param screenHtmlTransformer the screen html transformer
   * @param templateEngine the template engine
   * @param exporter the exporter
   */
  public ScreenHtmlGenerator(
      ScreenHtmlTransformer screenHtmlTransformer,
