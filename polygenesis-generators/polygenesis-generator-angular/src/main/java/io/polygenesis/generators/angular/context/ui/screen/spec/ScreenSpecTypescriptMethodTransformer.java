...
/**
 * The type Screen spec typescript method transformer.
 *
 * @author Christos Tsakostas
 */
public class ScreenSpecTypescriptMethodTransformer
  ...
  /**
   * Instantiates a new Screen spec typescript method transformer.
   *
   * @param dataTypeTransformer the data type transformer
   * @param activityRegistry the activity registry
   */
  public ScreenSpecTypescriptMethodTransformer(
      DataTypeTransformer dataTypeTransformer,
      ScreenSpecTypescriptActivityRegistry activityRegistry) {
