...
/**
 * The type Screen spec typescript transformer.
 *
 * @author Christos Tsakostas
 */
public class ScreenSpecTypescriptTransformer
  ...
  /**
   * Instantiates a new Screen spec typescript transformer.
   *
   * @param dataTypeTransformer the data type transformer
   * @param methodTransformer the method transformer
   */
  public ScreenSpecTypescriptTransformer(
      DataTypeTransformer dataTypeTransformer,
      ScreenSpecTypescriptMethodTransformer methodTransformer) {
