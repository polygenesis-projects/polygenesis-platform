...
public class UiMetamodelGenerator extends AbstractMetamodelGenerator {
  ...
  public void generate(Set<MetamodelRepository<?>> modelRepositories) {
    ...
    features.stream()
        ...
        .forEach(screen -> screenGenerator.generate(getGenerationPath(), screen));
  ...
  private ExportInfo widgetExportInfo(Path generationPath, Widget widget) {
    return ExportInfo.file(
        Paths.get(generationPath.toString(), AmgularFolderFileConstants.WIDGETS),
        String.format(
            "%s%s",
            TextConverter.toUpperCamel(widget.getObjectName().getText()),
