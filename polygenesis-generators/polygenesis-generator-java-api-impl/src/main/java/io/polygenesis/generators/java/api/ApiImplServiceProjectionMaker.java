 ...
 */
public class ApiImplServiceProjectionMaker extends AbstractServiceProjectionMaker {
   ...
   */
  public ApiImplServiceProjectionMaker(ApiImplMethodProjectionMaker methodProjectionMaker) {
