...
public final class JavaApiImplGeneratorFactory {
  ...
  static {
    ...
    ApiImplServiceProjectionMaker apiImplServiceProjectionMaker =
        new ApiImplServiceProjectionMaker(apiImplMethodProjectionMaker);

    apiImplServiceExporter =
        new ApiImplServiceExporter(freemarkerService, apiImplServiceProjectionMaker);
  }
   ...
   */
  public static JavaApiImplGenerator newInstance(Path generationPath) {
    return new JavaApiImplGenerator(generationPath, apiImplServiceExporter);
  }
}
