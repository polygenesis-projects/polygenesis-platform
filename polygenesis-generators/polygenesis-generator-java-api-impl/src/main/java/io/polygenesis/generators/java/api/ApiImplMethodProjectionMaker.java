 ...
 */
public class ApiImplMethodProjectionMaker extends AbstractMethodProjectionMaker {
   ...
   */
  public ApiImplMethodProjectionMaker(FromDataTypeToJavaConverter fromDataTypeToJavaConverter) {
