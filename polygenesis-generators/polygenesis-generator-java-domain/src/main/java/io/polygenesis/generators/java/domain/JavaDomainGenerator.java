...
public class JavaDomainGenerator extends AbstractGenerator {
   ...
   */
  public JavaDomainGenerator(Path generationPath, AggregateRootExporter aggregateRootExporter) {
  ...
  public void generate(Set<ModelRepository> modelRepositories) {
    ...
    domainModelRepository
        ...
        .forEach(
            aggregateRoot -> {
              aggregateRootExporter.export(getGenerationPath(), aggregateRoot);
            });
  }
