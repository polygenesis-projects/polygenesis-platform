...
@Ignore
public class ContextMoneyTransferTest {
  ...
  private static final String MONEY_TRANSFER_ROOT_PACKAGE = "com.finfin.moneytransfer";
  ...
  public void shouldCreateContext() {
    Context<Thing> context =
        ContextMoneyTransfer.get(
            new PackageName(String.format("%s.%s", JAVA_ROOT_PACKAGE, "moneytransfer")),
            contextGenerator("moneytransfer", "moneytransfer", "stc_", "moneytransfer"),
            deducers("moneytransfer"));
  ...
  private void makeAssertionsForInvoice(Context<Thing> context) {
    PackageName moneytransferRootPackageName = new PackageName(MONEY_TRANSFER_ROOT_PACKAGE);
            ...
            DataPrimitive.ofDataBusinessTypeWithDataObject(
                ...
                new DataObject(
                    ...
                    new ObjectName(
                        String.format(
                            "%sId", TextConverter.toLowerCamel(invoice.getThingName().getText()))),
                    invoice.makePackageName(moneytransferRootPackageName, invoice),
                    new LinkedHashSet<>(),
  ...
  private void makeAssertionsForInvoiceItem(Context<Thing> context) {
                ...
                new DataObject(
                    ...
                    new ObjectName(
                        String.format(
                            "%sId",
                            TextConverter.toLowerCamel(invoiceItem.getThingName().getText()))),
                    invoiceItem.makePackageName(moneytransferRootPackageName, invoiceItem),
                    new LinkedHashSet<>(),
                    DataSourceType.DEFAULT)));
    ...
    DataPrimitive title =
        DataPrimitive.of(
            ...
            Shared.title(moneytransferRootPackageName));
    ...
    DataPrimitive description =
        DataPrimitive.of(
            ...
            Shared.description(moneytransferRootPackageName));
    ...
    DataPrimitive quantity =
        DataPrimitive.of(
            ...
            Shared.quantity(moneytransferRootPackageName));
    ...
    DataPrimitive unitCost =
        DataPrimitive.of(
            ...
            Shared.unitCost(moneytransferRootPackageName));
    ...
    DataPrimitive lineTotal =
        DataPrimitive.of(
            ...
            Shared.lineTotal(moneytransferRootPackageName));
    assertThat(invoiceItem.getThingProperties().getData()).contains(lineTotal);

    // discount
    DataObject discount = Shared.discount(moneytransferRootPackageName);
