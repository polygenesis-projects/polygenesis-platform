...
public class Workspace {
  ...
  public static final String FUNCTION_NAME_VERIFY_DOMAIN = "verifyDomain";
  ...
  public static Thing create(PackageName rootPackageName) {
    ...
    workspace.addFunctions(
        PurposeFunctionBuilder.forThing(workspace, rootPackageName)
            ...
            .withFunctionModifyNoReturnValue(FUNCTION_NAME_VERIFY_DOMAIN, "", new LinkedHashSet<>())
  ...
  private static Set<Data> createData(PackageName rootPackageName) {
    return DataBuilder.create().withGroupData(Shared.domain(rootPackageName)).build();
  }
