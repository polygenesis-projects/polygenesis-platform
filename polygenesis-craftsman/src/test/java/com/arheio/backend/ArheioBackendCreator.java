...
package com.arheio.backend;

import com.arheio.contexts.archiving.ContextArchiving;
import com.arheio.contexts.auth.ContextAuth;
import com.arheio.contexts.notification.ContextNotification;
...
@Ignore
public class ArheioBackendCreator {

  private static final String JAVA_EXPORT_PATH = "/Users/tsakostas/work/repo/gitlab/arheio";
  private static final String JAVA_PROJECT_FOLDER = "arheio-backend";
  private static final String JAVA_ARTIFACT_ID = "arheio";
  private static final String JAVA_MODULE_PREFIX = "arheio";
  private static final String JAVA_CONTEXT = "arheio";
  private static final String JAVA_ROOT_PACKAGE = "com.arheio";
  ...
  private static ProjectDescription makeProjectDescription() {
    return new ProjectDescriptionBuilder()
        ...
        .setDescription("arheio")
        .setUrl("https://www.arheio.com")
        .setInceptionYear("2021")
        .setOrganizationName("arheio")
        .setOrganizationUrl("https://www.arheio.com")
        ...
        .setScmConnection("scm:git:git://gitlab.com/arheio-projects/arheio-backend.git")
        .setScmDeveloperConnection("scm:git:git@gitlab.com:arheio-projects/arheio-backend.git")
        .setScmUrl("https://gitlab.com/arheio-projects/arheio-backend")
