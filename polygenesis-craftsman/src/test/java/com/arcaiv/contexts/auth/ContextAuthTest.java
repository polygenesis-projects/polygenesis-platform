...
public class ContextAuthTest {
  ...
  private static final String ACCESS_ROOT_PACKAGE = "com.arcaiv.auth";
  ...
  public void shouldCreateContext() {
    Context<Thing> context =
        ContextAuth.get(
            ...
            contextGenerator("auth", "auth", "acs_", "auth"),
            deducers("auth"));

    assertThat(context).isNotNull();
    context.populateMetamodelRepositories(deducers("auth"));
  ...
  private void makeAssertionsForConfirmation(Context<Thing> context) {
    PackageName authRootPackageName = new PackageName(ACCESS_ROOT_PACKAGE);
                ...
                new DataObject(
                    ...
                    new ObjectName(
                        String.format(
                            "%sId",
                            TextConverter.toLowerCamel(confirmation.getThingName().getText()))),
                    confirmation.makePackageName(authRootPackageName, confirmation),
                    new LinkedHashSet<>(),
