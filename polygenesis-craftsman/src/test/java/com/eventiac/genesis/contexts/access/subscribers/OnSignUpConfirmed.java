...
package com.eventiac.genesis.contexts.access.subscribers;
...
public class OnSignUpConfirmed {
  ...
  private static Set<Data> messageData(PackageName rootPackageName) {
    DataObject email =
        new DataObject(new ObjectName("email"), new PackageName("com.staticfy.access.identity"));
    email.addData(DataPrimitive.of(PrimitiveType.STRING, new VariableName("value")));

    DataObject password =
        new DataObject(new ObjectName("password"), new PackageName("com.staticfy.access.identity"));
