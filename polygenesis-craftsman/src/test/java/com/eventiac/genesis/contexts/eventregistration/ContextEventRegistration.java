...
package com.eventiac.genesis.contexts.eventregistration;

import com.eventiac.genesis.contexts.staticization.Demo;
...
public class ContextEventRegistration {
  ...
  public static ThingContext get(
    ...
    return ThingContextBuilder.of("merchant-event", contextGenerator)
