 ...
 */
public class CreateAggregateEntity implements MethodImplementor<StateMutationMethod> {
  ...
  public String implementationFor(
    ...
    return freemarkerService.exportToString(
        dataModel, "polygenesis-implementation-java-domain/create-aggregate-entity.ftl");
  }
}
