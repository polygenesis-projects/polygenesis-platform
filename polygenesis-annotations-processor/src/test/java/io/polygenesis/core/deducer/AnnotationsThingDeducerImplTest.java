...
public class AnnotationsThingDeducerImplTest {
  ...
  public void deduce() {
    ...
    Assertions.assertThat(repository.getApiThings()).isNotNull();
    Assertions.assertThat(repository.getApiThings().size()).isEqualTo(1);
    Assertions.assertThat(repository.getThingByName(new ThingName("someThing"))).isPresent();
    ...
    Assertions.assertThat(someThing.getFunctions().size()).isEqualTo(5);
  ...
  private void assertionsForGoalCalculation(Thing someThing) {
    ...
    Assertions.assertThat(functionCalculation.getReturnValue()).isNotNull();
    Assertions.assertThat(functionCalculation.getArguments().size()).isEqualTo(2);
  }
}
