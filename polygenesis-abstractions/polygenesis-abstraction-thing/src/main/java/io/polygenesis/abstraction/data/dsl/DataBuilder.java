...
public class DataBuilder {
  ...
  /**
   * With text property to value object data text builder.
   *
   * @param propertyName the property name
   ...
   */
  public final DataTextBuilder withTextPropertyToValueObject(
      String propertyName, DataObject dataObject) {
    DataTextBuilder dataTextBuilder =
        DataTextBuilder.create(
            this, propertyName, dataObject.getObjectName(), dataObject.getPackageName());
  ...
  /**
   * With decimal property to value object data decimal builder.
   *
   * @param propertyName the property name
   * @param dataObject the data object
   * @return the data decimal builder
   */
  public final DataDecimalBuilder withDecimalPropertyToValueObject(
      String propertyName, DataObject dataObject) {
    DataDecimalBuilder dataDecimalBuilder =
        DataDecimalBuilder.create(
            this, propertyName, dataObject.getObjectName(), dataObject.getPackageName());
  ...
  /**
   * With reference to thing by id data builder.
   *
