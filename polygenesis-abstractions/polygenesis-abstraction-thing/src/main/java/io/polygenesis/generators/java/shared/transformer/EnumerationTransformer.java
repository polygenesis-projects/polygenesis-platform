...
/**
 * The interface Enumeration transformer.
 *
 * @param <S> the type parameter
 * @author Christos Tsakostas
 */
public interface EnumerationTransformer<S> extends TemplateTransformer<S> {

  /**
   * Create enumeration representation.
   *
  ...
  EnumerationRepresentation create(S source, Object... args);

  /**
   * Enumeration values representations set.
   *
   * @param source the source
   * @param args the args
   * @return the set
   */
  Set<EnumerationValueRepresentation> enumerationValueRepresentations(S source, Object... args);
