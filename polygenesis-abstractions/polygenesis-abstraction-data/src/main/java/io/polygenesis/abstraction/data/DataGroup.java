...
public class DataGroup extends Data {
  ...
  /**
   * With variable name data group.
   *
   * @param variableName the variable name
   * @return the data group
   */
  public DataGroup withVariableName(String variableName) {
    return new DataGroup(
  ...
  /**
   * With variable name equal to object name data group.
   *
   * @return the data group
   */
  public DataGroup withVariableNameEqualToObjectName() {
    return new DataGroup(
