...
public class ScaffolderJavaMicroserviceTest {

  @Test
  public void scaffold() {
    ScaffolderJavaMicroservice scaffolderJavaMicroservice =
        ScaffolderJavaMicroserviceFactory.newInstance(Paths.get("tmp"));
    ...
    scaffolderJavaMicroservice.scaffold(Paths.get("tmp/some-microservice"), projectDescription);
  }
}
