 ...
 */
public class SecondaryAdapterRdbmsScaffolder extends AbstractScaffolder {
   ...
   */
  public SecondaryAdapterRdbmsScaffolder(FreemarkerService freemarkerService) {
  ...
  public void scaffold(
    ...
    Path modulePath =
        Paths.get(
            ...
            projectDescription.getModulePrefix() + "-persistence-rdbms");
    ensureSources(modulePath, projectDescription);

    freemarkerService.export(
        dataModel,
        "polygenesis-scaffolder-java-microservice/secondary-adapters/persistence-rdbms/pom.xml.ftl",
