...
/**
 * The type Module scaffolder.
 *
 * @author Christos Tsakostas
 */
public class ModuleScaffolder extends AbstractScaffolder {
  ...
  /**
   * Instantiates a new Module scaffolder.
   *
   * @param freemarkerService the freemarker service
   */
  public ModuleScaffolder(FreemarkerService freemarkerService) {
  ...
  private void scaffoldModule(
    ...
    freemarkerService.export(
        dataModel,
        "polygenesis-scaffolder-java-microservice/module/pom.xml.ftl",
