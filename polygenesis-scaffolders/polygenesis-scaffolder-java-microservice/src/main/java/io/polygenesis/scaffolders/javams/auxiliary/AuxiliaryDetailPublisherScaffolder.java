 ...
 */
public class AuxiliaryDetailPublisherScaffolder extends AbstractScaffolder {
   ...
   */
  public AuxiliaryDetailPublisherScaffolder(FreemarkerService freemarkerService) {
  ...
  public void scaffold(
    ...
    freemarkerService.export(
        ...
        "polygenesis-scaffolder-java-microservice"
            + "/auxiliary-details/publisher-activemq/pom.xml.ftl",
