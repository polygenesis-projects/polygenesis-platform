...
public class PrimaryAdapterRestScaffolder extends AbstractScaffolder {
   ...
   */
  public PrimaryAdapterRestScaffolder(FreemarkerService freemarkerService) {
  ...
  public void scaffold(Path generationPath, ProjectDescription projectDescription,
    ...
    Path modulePath =
        Paths.get(
            ...
            projectDescription.getModulePrefix() + "-rest-spring");
    ensureSources(modulePath, projectDescription);

    freemarkerService.export(
        dataModel,
        "polygenesis-scaffolder-java-microservice/primary-adapters/rest-spring/pom.xml.ftl",
