 ...
 */
public class ApiImplScaffolder extends AbstractScaffolder {
   ...
   */
  public ApiImplScaffolder(FreemarkerService freemarkerService) {
  ...
  public void scaffold(
    ...
    freemarkerService.export(
        dataModel,
        "polygenesis-scaffolder-java-microservice/api-impl/pom.xml.ftl",
