 ...
 */
public class SecondaryAdapterPublisherScaffolder extends AbstractScaffolder {
   ...
   */
  public SecondaryAdapterPublisherScaffolder(FreemarkerService freemarkerService) {
  ...
  public void scaffold(
    ...
    freemarkerService.export(
        dataModel,
        "polygenesis-scaffolder-java-microservice"
            + "/secondary-adapters/publisher-activemq/pom.xml.ftl",
